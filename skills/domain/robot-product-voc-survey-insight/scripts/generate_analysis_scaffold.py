...
def build_action_plan_rows(
    ...
    rows: list[list[object]] = []
    skill_text = "、".join(
        [name for name in action_context.get("skill_names", []) if name in {"OptiFlow", "Nexus", "robot-product-voc-survey-insight", "excel-xlsx"}]
    ) or "OptiFlow、Nexus、robot-product-voc-survey-insight"
