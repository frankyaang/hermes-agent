...
MEMORY_GUIDANCE = (
    ...
    "Business facts (product decisions, org info, meeting conclusions, customer data) "
    "do NOT belong in memory — save them with knowledge_write (or pending capture if "
    "conditions are not met). Memory is for user preferences and personal conventions only."
)

KNOWLEDGE_GUIDANCE = (
    "# Knowledge and memory routing\n"
    "Asset routing:\n"
    "- User preferences / tool quirks / personal conventions → memory tool\n"
    "- Product-line facts / org decisions / meeting conclusions → knowledge_write\n"
    "- Reusable workflows / templates / playbooks → skill_manage\n"
    "- When knowledge fields incomplete/ACL unclear → pending capture "
    "(knowledge_write auto-saves on failure)\n\n"
    "Company-level scope: use product_line_id=\"ecovacs_company\" for CEO/executive "
    "decisions, org structure, company strategy.\n"
    "Common aliases auto-resolved: cleaning_robot→deebot, 地宝→deebot, "
    "ecovacs/科沃斯/company→ecovacs_company\n\n"
